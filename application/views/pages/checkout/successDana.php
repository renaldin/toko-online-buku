		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header kotak">
					Checkout Berhasil <img src="<?= base_url('/images/gambar/dana.png')?>" width="60" alt="">
				</div>
				<div class="card-body">
					...
					<ol>
						<li>Lakukan pembayaran pada nomor <strong>DANA <b>083854876787</b></strong> a/n PT. BukuPedia</li>
