		...
		<div class="col-md-10 mx-auto">
			<div class="card mb-3">
				<div class="card-header kotak">
					...
					<a href="<?= base_url('product/create') ?>" class="btn btn-sm tombol text-white"><b>Tambah</b></a>
						...
						<form action="<?= base_url("product/search") ?>" method="POST">
							<div class="input-group">
								...
								<div class="input-group-append">
									...
									<a href="<?= base_url("product/reset") ?>" class="btn tombol text-white btn-sm">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="badge tombol text-white" ><i class="fas fa-tags"></i> <?= $row->category_title ?></span>
								</td>
								...
								<td>
									...
									<a href="<?= base_url("/product/edit/$row->id") ?>" class="btn btn-sm tombol" style="border-radius: 50%;">
