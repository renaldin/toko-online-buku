...
class MY_Model extends CI_Model 
{
	...
	public function makePagination($baseUrl, $uriSegment, $totalRows = null)
	{
		...
		$config = [
			...
			'first_tag_close'	=> '</li>',
			'prev_link'			=> '&laquo',
			'prev_tag_open'		=> '<li class="page-item" style="background-color: rgba(0, 0, 109, 0.904);">',
			'prev_tag_close'	=> '</li>',
			'next_link'			=> '&raquo',
			'next_tag_open'		=> '<li class="page-item" style="background-color: rgba(0, 0, 109, 0.904);">',
			'next_tag_close'	=> '</li>',
			'last_tag_open'		=> '<li class="page-item" style="background-color: rgba(0, 0, 109, 0.904);">',
			'last_tag_close'	=> '</li>',
			'cur_tag_open'		=> '<li class="page-item active"><a href="#" class="page-link" style= "background-color: rgba(0, 0, 109, 0.904);">',
			'cur_tag_close'		=> '<span class="sr-only">(current)</span></a></li>',
			'num_tag_open'		=> '<li class="page-item" style="background-color: rgba(0, 0, 109, 0.904);">',
			'num_tag_close'		=> '</li>',
		];
